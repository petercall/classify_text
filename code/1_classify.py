...
#Hyperparameters--------------------------------------------------------------------------------------------------------------------------------------------------------
DATA_FILE = "../../../data/olmo/phi_2000_generations_temp_1.5.csv"
COL_OF_INT = "text"             #This is the column it will be doing the classifying based on
...
BATCH_SIZE = 64
SAVE_FREQ = 500     #This is the number of data points after which it will save (NOT the number of batches)
#--------------------------------------------------------------------------------------------------------------------------------------------------------------------
