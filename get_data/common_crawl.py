...
"""
The purpose of this file is to get a random sample of the common crawl dataset

In this file I do the following:
    1. Read in the common crawl dataset with streaming=True
...
save_location = '../../../data/olmo/cc_dataset.csv'   #This is the location to save the csv file
#------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
